...
const TYPE_COLOR: Record<LogEntry['type'], string> = {
  ...
  player_out: 'text-[var(--color-accent-soft)]',
...
export function ActionHistoryPanel({ hideTriggers, externalToggleRef }: ActionHistoryPanelProps = {}) {
  ...
  return (
    <>
      {/* ── DESKTOP: feed flutuante à esquerda (oculto em mobile). Sempre
          visivel no PC mesmo com hideTriggers — e a forma natural de ver
          as ultimas jogadas no desktop. hideTriggers afeta apenas o gatilho
          mobile interno. */}
      <motion.div
