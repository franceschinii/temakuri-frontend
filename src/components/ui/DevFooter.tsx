    ...
    <div className="px-6 py-2 border-t border-[var(--color-border)]/40 shrink-0">
      ...
      <div className="flex flex-col gap-0.5 sm:hidden">
        <div className="flex items-center justify-between">
          ...
          <span className="text-[10px] text-[var(--color-text-muted)] opacity-25 font-mono">v0.5.0-beta</span>
        </div>
        <div className="flex items-center justify-between">
          <a
      ...
      <div className="hidden sm:flex items-center justify-between">
        <div className="flex items-center gap-1.5 opacity-40">
          ...
          <span className="text-[10px] text-[var(--color-text-muted)] font-mono opacity-70">v0.5.0-beta</span>
        </div>
